...
export default function Footer() {
  ...
  return (
    <footer className={`w-full px-6 py-10 bg-white shadow text-black transition-all border-t border-gray-200`}> 
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
        ...
        <div className="flex justify-between md:justify-center md:space-x-20">
          <div>
            <p className="text-sm font-semibold text-gray-500 mb-1">Projects</p>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1">
              ...
              <li><a href="#" className="hover:underline">Read.cv ↗</a></li>
              <li><a href="sirsebastianrojas@gmail.com" className="hover:underline">Mail ↗</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end">
          ...
          <p className="text-xs">Made with ❤️ and Strawberry Matcha Lattes (120% sugar, less ice).</p>
        </div>
      </div>
    </footer>
  );
